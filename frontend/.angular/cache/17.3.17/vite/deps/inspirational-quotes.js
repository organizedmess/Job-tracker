...
// node_modules/inspirational-quotes/data/data.json
var require_data = __commonJS({
  "node_modules/inspirational-quotes/data/data.json"(exports, module) {
    module.exports = [
      {
...
// node_modules/inspirational-quotes/lib/index.js
var require_lib = __commonJS({
  "node_modules/inspirational-quotes/lib/index.js"(exports, module) {
    var arr = require_data();
    var randomInt = (min, max) => Math.floor(Math.random() * (max - min + 1) + min);
    var index = randomInt(0, arr.length);
    var getRandomQuote = () => arr[index].text;
    var getQuote = (options) => {
...
//# sourceMappingURL=inspirational-quotes.js.map
